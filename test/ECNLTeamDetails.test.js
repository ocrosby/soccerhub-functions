...
const httpFunction = require('../ECNLTeamDetails/index');
const context = require('./defaultContext');

describe('ECNLTeamDetails', () => {
    let sandbox;
    ...
    it('behaves as expected when the request is successful', async () => {
        ...
        expect(context.log.calledWith('Successfully retrieved details for "something".')).to.be.true;
        expect(context.res.body).to.equal(data[0]);
    });
