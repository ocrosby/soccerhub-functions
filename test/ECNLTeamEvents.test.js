...
const httpFunction = require('../ECNLTeamEvents/index');
const context = require('./defaultContext');

describe('ECNLTeamEvents', () => {
    let sandbox;
    ...
    it('behaves as expected when the request is successful', async () => {
        ...
        expect(context.log.calledWith('Successfully retrieved events for team "13"')).to.be.true;
